...
//counterfeiter:generate -o ../../../fakes/off_thread . Operator
...
type (
	Operator interface {
		Op(fn func(data ...interface{}) (any, error), data ...interface{})
...
func (op *OffThread) Op(fn func(data ...interface{}) (any, error), data ...interface{}) {
	op.wg.Add(1)
	op.limiter <- struct{}{}
	go func() {
		defer func() {
