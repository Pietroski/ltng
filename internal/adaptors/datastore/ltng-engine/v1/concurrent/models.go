...
type (
	LTNGEngine struct {
		...
		mainThreadOperatorChan         chan *InputInfoData
		mainThreadOperatorRollbackChan chan *InputInfoData

		indexThreadOperatorChan         chan *InputInfoData
		indexThreadOperatorRollbackChan chan *InputInfoData

		indexListThreadOperatorChan         chan *InputInfoData
		indexListThreadOperatorRollbackChan chan *InputInfoData

		relationalThreadOperatorChan         chan *InputInfoData
		relationalThreadOperatorRollbackChan chan *InputInfoData
	}
...
func (i *InputInfoData) WithContext(ctx context.Context) *InputInfoData {
	i.ctx = ctx
	return i
}

func (i *InputInfoData) WithRespChan(sigChan chan error) *InputInfoData {
