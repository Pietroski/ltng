...
func newOpSaga(ctx context.Context, e *LTNGEngine) *opSaga {
	...
	op := &opSaga{
		...
		crudChannels: &v4.CrudChannels{
			OpSagaChannel:  v4.MakeOpChannels(),
			CreateChannels: v4.MakeOpChannels(),
			UpsertChannels: v4.MakeOpChannels(),
			DeleteChannels: v4.MakeOpChannels(),
		},
...
func (op *opSaga) listenAndTrigger(ctx context.Context) error {
	...
	var itemInfoData v4.ItemInfoData
