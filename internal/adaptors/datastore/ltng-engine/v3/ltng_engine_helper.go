...
func newLTNGEngine(
	...
	engine := &LTNGEngine{
		...
		storeFileMapping:           syncx.NewGenericMap[*v4.FileInfo](),
		itemFileMapping:            syncx.NewGenericMap[*v4.FileInfo](),
		relationalStoreFileMapping: syncx.NewGenericMap[*v4.RelationalFileInfo](),
		relationalItemFileMapping:  syncx.NewGenericMap[*v4.RelationalFileInfo](),
		...
		mngrStoreInfo: v4.DBManagerStoreInfo,
	}
...
func (e *LTNGEngine) closeStores() {
	e.storeFileMapping.RangeAndDelete(
		func(fileStore string, value *v4.FileInfo) bool {
...
func (e *LTNGEngine) closeItems() {
	...
	if err := e.fq.Close(); err != nil {
		e.logger.Error(e.ctx, "error closing file queue")
	}
	...
	e.itemFileMapping.RangeAndDelete(func(fileItem string, value *v4.FileInfo) bool {
		if !osx.IsFileClosed(value.File) {
			if err := value.File.Close(); err != nil {
