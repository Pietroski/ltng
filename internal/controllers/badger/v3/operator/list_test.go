...
func TestBadgerDBServiceController_List(t *testing.T) {
	t.Run(
		...
		func(t *testing.T) {
			...
			var pagination badgerdb_management_models_v3.Pagination
	...
	t.Run(
		...
		func(t *testing.T) {
			...
			var pagination badgerdb_management_models_v3.Pagination
			//dbPayload := &badgerdb_management_models_v3.Pagination{}
			dbInfo := &badgerdb_management_models_v3.DBMemoryInfo{
				Name:         dbName,
			...
			mockOperator.
				...
				Times(1).
				Return(badgerdb_operation_models_v3.Items{}, fmt.Errorf("any-error"))
	...
	t.Run(
		...
		func(t *testing.T) {
			...
			listValues := badgerdb_operation_models_v3.Items{
				{
					Key:   []byte("key-1"),
					Value: []byte("value-1"),
				},
