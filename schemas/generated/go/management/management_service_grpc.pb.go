...
func (c *managementClient) CreateStore(ctx context.Context, in *CreateStoreRequest, opts ...grpc.CallOption) (*CreateStoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/management.Management/CreateStore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementClient) RestartLightningNode(ctx context.Context, in *RestartLightningNodeRequest, opts ...grpc.CallOption) (*RestartLightningNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/management.Management/RestartLightningNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementClient) ShutdownLightningNode(ctx context.Context, in *ShutdownLightningNodeRequest, opts ...grpc.CallOption) (*ShutdownLightningNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/management.Management/ShutdownLightningNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Management_CreateStore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/management.Management/CreateStore",
	}
...
func _Management_DeleteStore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/management.Management/DeleteStore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Management_GetStore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/management.Management/GetStore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Management_RestartLightningNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/management.Management/RestartLightningNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Management_ShutdownLightningNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/management.Management/ShutdownLightningNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
