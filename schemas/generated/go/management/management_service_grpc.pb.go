...
func (c *managementClient) GetStore(ctx context.Context, in *GetStoreRequest, opts ...grpc.CallOption) (*GetStoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, Management_GetStore_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementClient) RestartLightningNode(ctx context.Context, in *RestartLightningNodeRequest, opts ...grpc.CallOption) (*RestartLightningNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Management_RestartLightningNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementClient) ShutdownLightningNode(ctx context.Context, in *ShutdownLightningNodeRequest, opts ...grpc.CallOption) (*ShutdownLightningNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Management_ShutdownLightningNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementClient) CheckManagerEngine(ctx context.Context, in *config.CheckEngineRequest, opts ...grpc.CallOption) (*config.CheckEngineResponse, error) {
	...
	err := c.cc.Invoke(ctx, Management_CheckManagerEngine_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
