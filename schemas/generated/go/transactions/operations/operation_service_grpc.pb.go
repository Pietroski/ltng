...
func (c *operationClient) Upsert(ctx context.Context, in *UpsertRequest, opts ...grpc.CallOption) (*UpsertResponse, error) {
	...
	err := c.cc.Invoke(ctx, Operation_Upsert_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *operationClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, Operation_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *operationClient) Load(ctx context.Context, in *LoadRequest, opts ...grpc.CallOption) (*LoadResponse, error) {
	...
	err := c.cc.Invoke(ctx, Operation_Load_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *operationClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Operation_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *operationClient) ListValuesFromIndexingKeys(ctx context.Context, in *ListValuesFromIndexingKeysRequest, opts ...grpc.CallOption) (*ListValuesFromIndexingKeysResponse, error) {
	...
	err := c.cc.Invoke(ctx, Operation_ListValuesFromIndexingKeys_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *operationClient) CheckOperatorEngine(ctx context.Context, in *config.CheckEngineRequest, opts ...grpc.CallOption) (*config.CheckEngineResponse, error) {
	...
	err := c.cc.Invoke(ctx, Operation_CheckOperatorEngine_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
