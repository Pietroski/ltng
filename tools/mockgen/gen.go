...
// pkg
//go:generate mockgen -package mocked_ltng_client -destination ../../pkg/client/mocks/ltng_client_mock.go gitlab.com/pietroski-software-company/lightning-db/pkg/client LTNGClient
